...
class MealService:
    def __init__(self):
        ...
        if self.client is None:
            print("⚠️ Warning: Supabase client not available. Meal operations will fail.")
    ...
    async def get_meals_by_cuisine(self, cuisine: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = self.client.table('meals').select('*').eq('cuisine', cuisine).execute()
    ...
    async def get_meals_by_diet(self, diet_type: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = self.client.table('meals').select('*').eq('diet_type', diet_type).execute()
            return response.data if response.data else []
        except Exception as e:
            print(f"Error getting meals by diet: {e}")
            return []
    
    async def search_meals(self, query: str, user_preferences: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
            ...
            if query:
                ...
                for meal in meals:
                    ...
                    if (query_lower in meal['name'].lower() or
                        any(query_lower in ingredient.lower() for ingredient in meal.get('ingredients', [])) or
                        any(query_lower in tag.lower() for tag in meal.get('tags', []))):
    ...
    async def populate_indian_meals(self) -> bool:
        ...
        indian_meals = [
            # North Indian dishes
            {
                ...
                "ingredients": ["chicken", "tomato", "cream", "butter", "garam masala", "onion", "garlic", "ginger"],
            ...
            },
            {
                "name": "Dal Makhani",
                "cuisine": "north_indian",
                "ingredients": ["black lentils", "kidney beans", "cream", "butter", "tomato", "onion", "garlic", "ginger"],
            ...
            },
            {
                "name": "Palak Paneer",
                "cuisine": "north_indian",
                "ingredients": ["spinach", "paneer", "onion", "tomato", "cream", "garlic", "ginger", "spices"],
            ...
            },
            {
                "name": "Sambar",
                "cuisine": "south_indian",
                "ingredients": ["toor dal", "tamarind", "drumstick", "okra", "onion", "tomato", "sambar powder"],
            ...
            },
            {
                "name": "Fish Curry",
                "cuisine": "south_indian",
                "ingredients": ["fish", "coconut", "tamarind", "curry leaves", "mustard seeds", "red chili", "turmeric"],
            ...
            },
            {
                ...
                "cuisine": "punjabi",
                "ingredients": ["corn flour", "mustard greens", "spinach", "butter", "jaggery", "ginger", "garlic"],
            ...
            # Indo-Chinese dishes
            {
                ...
                "ingredients": ["chicken", "bell peppers", "onion", "soy sauce", "chili sauce", "garlic", "ginger"],
            ...
            },
            {
                ...
                "cuisine": "indo_chinese",
                "ingredients": ["rice", "mixed vegetables", "soy sauce", "spring onions", "garlic", "ginger", "oil"],
            ...
            },
            {
                "name": "Undhiyu",
                "cuisine": "gujarati",
                "ingredients": ["mixed vegetables", "purple yam", "sweet potato", "eggplant", "coconut", "peanuts"],
            ...
            # Bengali dishes
            {
                "name": "Fish Jhol",
                "cuisine": "bengali",
                "ingredients": ["fish", "potato", "onion", "tomato", "turmeric", "cumin", "mustard oil"],
        ...
        try:
            ...
            new_meals = [meal for meal in indian_meals if meal['name'] not in existing_names]
            
            if new_meals:
                response = self.client.table('meals').insert(new_meals).execute()
                if response.data:
                    print(f"✅ Successfully added {len(new_meals)} Indian meals to database")
                    return True
                else:
